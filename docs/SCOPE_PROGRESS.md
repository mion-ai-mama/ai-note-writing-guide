...
- [ ] STEP1〜4のスクリーンショット7点（現在は【スクリーンショット】のプレースホルダー表示）
      - STEP1: Substackのトップページ／登録フォームの入力画面
      - STEP2: キーワードで検索している画面／検索結果一覧の画面
      - STEP3: ChatGPTにURLを貼り付けている画面／日本語に訳された結果の画面
      - STEP4: ChatGPTにプロンプトを送った結果の画面
